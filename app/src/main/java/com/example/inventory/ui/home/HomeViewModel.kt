...
// poder observar los cambios de la IU
// acceder a los datos de los usuarios

    //mantiene el estado de la IU
...
* Es una clase de datos simple que contiene una lista
* de ítems (itemList). Esto encapsula el estado de la pantalla principal y se pasa a la UI.
*/
